...
This walkthrough converts Elekta Neuromag MEG data into a validated, shareable BIDS dataset. The data and instructions come from the [MNE-BIDS developers](https://mne.tools/mne-bids/stable/auto_examples/convert_mne_sample.html) — BIDSvue provides a graphical wrapper for their tool.
...
> [!TIP]
> The original dataset encodes events as numbers. BIDSvue detects the distinct events for you, but you'll still want to give each a meaningful name.
